...
const AdminContent = (props) => {
    return (
        <div className="ml-72 px-8 pt-8 bg-gray-200 mt-19 min-h-screen pb-10">
            <Switch>
                {props.role == 1 ? (
                    <>
                        <Route
                        ...
                        />
                        <Route
                            path="/admin/booktypes/add"
                            exact
                            component={AddBookType}
                        />
                        <Route
                            path="/admin/booktypes/edit/:id"
                            exact
                        ...
                        />
                        <Route
                            path="/admin/itinTeach"
                            exact
                            component={ITinTeach}
                        />
                        <Route
                            path="/admin/itinTeach/updateITinTeach/:id"
                            exact
                            component={EditITINTeach}
                        />
                        <Route
                            path="/admin/itinTeach/add"
                            exact
                            component={AddITinTeach}
                        />
                        {/* CRUD category course */}
                        <Route
                            path="/admin/category_courses"
                            exact
                            component={CategoryCourse}
                        />
                        <Route
                            path="/admin/category_courses/add"
                            exact
                            component={AddCategoryCourse}
                        />
                        <Route
                            path="/admin/category_courses/:id/edit"
                            exact
                            component={EditCategoryCourse}
                        />
                        {/* CRUD course */}
                        <Route
                            path="/admin/courses"
                        ...
                        />
                        <Route
                            path="/admin/courses_add"
                            exact
                            component={AddCourse}
                        />
                        <Route
                            path="/admin/courses/:id_cate"
                            exact
                            component={Courses}
                        />
                        <Route
                        ...
                        {/* CRUD table content */}
                        <Route
                            path="/admin/table_content"
                            exact
                            component={TableContent}
                        />
                        <Route
                            path="/admin/table_content/:id_course"
                            exact
                            component={TableContent}
                        />
                        <Route
                            path="/admin/table_content_add"
                            exact
                            component={AddTableContent}
                        />
                        <Route
                            path="/admin/table_content/:id/edit"
                            exact
                        ...
                        />
                        <Route
                            path="/admin/lessons/:id_content"
                            exact
                            component={Lessson}
                        />
                        <Route
                            path="/admin/lessons_add"
                            exact
                            component={AddLesson}
                        />
                        <Route
                        ...
                        <Route
                            path="/admin/exam/addCategory"
                            exact
                            component={AddCategory}
                        />
                        <Route
                            path="/admin/exam/editCategory/:id"
                            exact
                            component={EditCategory}
                        />
                        <Route
                            path="/admin/exam/addExam"
                            exact
                            component={AddExam}
                        />
                        <Route
                            path="/admin/exam/editExam/:id"
                            exact
                            component={EditExam}
                        />
                        <Route
                            path="/admin/exam/indexQuestionExam/:id"
                            exact
                            component={IndexQuestionExam}
                        />
                        <Route
                            path="/admin/exam/:idExam/editQuestion/:id"
                            exact
                            component={EditQuestion}
                        />
                        <Route
                            path="/admin/exam/:idExam/addQuestionAnswer/:num"
                            exact
                        ...
                        />
                        <Route
                            path="/admin/featured_post"
                            exact
                            component={PostTable}
                        />
                        <Route
                            path="/admin/featured_post/add"
                            exact
                            component={AddPost}
                        />
                        <Route
                            path="/admin/featured_post/edit/:id"
                            exact
                            component={EditPost}
                        />
                        <Route
                            path="/admin/other_document"
                            exact
                            component={DocumentTable}
                        />
                        <Route
                            path="/admin/other_document/addDocumentCategory"
                            exact
                            component={AddDocumentCategory}
                        />
                        <Route
                            path="/admin/other_document/editDocumentCategory/:id"
                            exact
