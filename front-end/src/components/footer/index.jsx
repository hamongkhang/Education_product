                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <Link
                                        ...
                                        href="#"
                                    >
                                        THPT Tây Sơn - Mỹ An - Tây Bình - Tây
                                        Sơn - Bình Định
                                    </Link>
                                </li>
                                <li>
                        ...
                        <div className="lg:w-1/3 md:w-1/2 w-full px-4">
                            <nav className="list-none mb-10">
                                ...
                                <li>
                                    <a
                                        className="text-white hover:text-red-300"
                                        href="https://www.facebook.com/groups/867025087270480/user/100003241838165/"
                                    >
                                        Cộng tác viên
                                    </a>
                                </li>
                    ...
                    <div className="border-t-2 border-white">
                        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                            ...
                            <span className="inline-flex items-center sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start space-x-3">
                                ...
                                <a
                                    href="https://www.youtube.com/channel/UCOtbYT8Sm3i5G8UAAO584rw"
                                    className="text-gray-200 text-xl"
                                >
