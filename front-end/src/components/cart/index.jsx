...
const Cart = (props) => (
    <div>
        <div className="fixed cart-area transform translate-x-full top-0 right-0 bottom-0 overflow-hidden bg-white w-2/6 shadow-2xl z-20 duration-500">
            <div className="flex justify-between items-center mb-5 shadow-md px-5 py-3">
        ...
        <div className="cart-overlay fixed top-0 bottom-0 left-0 z-20 transform -translate-x-full duration-500 bg-penetration-5 cursor-pointer w-4/6"></div>
    </div>
)
