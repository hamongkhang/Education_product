    ...
    const renderCheckValidationForm = () => {
        return (
            <div className="errors">
                ...
                {!validateEmail(dataForm.email) && (
                    <span>Email bạn không đúng</span>
                )}
                {dataForm.password === '' && (
                    <span>Password bạn chưa nhập</span>
                )}
                {dataForm.password.length < 8 && (
                    <span>Password cần 8 ký tự</span>
                )}
                {dataForm.confirm_password === '' && (
                    <span>Confirm Password chưa nhập</span>
                )}
                {dataForm.password !== dataForm.confirm_password && (
                    <span>Password không khớp</span>
                )}
            </div>
        );
    };
            ...
            <div className="boxState">
                <div className="box">
                    <svg>
                        ...
                        <circle
                            className="p50"
                            className={phantram > 0 ? 'p' + phantram : 'p25'}
                            cx="70px"
                            cy="70px"
                            r="70px"
                        ></circle>
