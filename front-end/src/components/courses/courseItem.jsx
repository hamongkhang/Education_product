...
const CourseItem = (props) => {
    ...
    return (
        <div className="shadow-md mr-2 rounded-md overflow-hidden mb-10 bg-white">
            <div>
                <img
                    src={$linkImage + props.data.image}
            ...
            <div className="px-4 py-2">
                <div className="my-1">
                    <a href="#" className="hover:text-indigo-600 duration-300">
                        <h3 className="font-semibold line-2">
                            {props.data.name}
                        </h3>
                    </a>
                </div>
                ...
                <div>
                    <a href="#" className="flex items-center space-x-2">
                        <img
                            src={$link + props.admin.avatar}
                            className="w-9 h-9 object-cover rounded-full shadow-md border border-white duration-300 hover:opacity-70"
                            alt=""
                        />
                        <h4 className="font-semibold duration-300 hover:text-green-900">
                            Trần Quốc Quân
                        </h4>
                    </a>
                </div>
            ...
            <div className="border-t border-gray-300 p-4 flex justify-between">
                <div>
                    ...
                    <label htmlFor="" className="line-through text-xs ml-1">
                        {props.data.Initial_price}
                        <sup> đ</sup>
                    </label>
                </div>
                <Link
                    to={'/khoa-hoc/' + props.data.id}
