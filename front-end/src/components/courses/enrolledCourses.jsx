    ...
    return (
        <div className="">
            <div className="flex flex-col md:flex-row items-start justify-between uppercase font-semibold mt-5">
                ...
                <div>
                    <input type="text" onChange={(event) => addSearch(event)} className="px-3 py-2 border-2 hover:border-gray-400 rounded w-80 outline-none focus:border-indigo-500" placeholder="Tìm kiếm"/>
                </div>
            </div>
