...
const BookItem = (props) => {
    return (
        <div className="relative shadow-md group bg-indigo-100 overflow-hidden h-96 mr-2 rounded-lg mb-10">
            <div className="w-full h-64 flex items-center justify-center">
                <img src="./assets/images/slider/city.jpg" className="w-40 h-56 object-cover relative transform hover:translate-x-3 duration-300" alt="" />
            </div>
            <div className="px-6 text-center h-10">
                <h3 className="font-semibold line-2">The Perfect Marriage by Jeneva Rose</h3>
                <span className="text-indigo-500 block mb-2">250.000<sup>đ</sup></span>
            </div>
