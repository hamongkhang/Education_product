            ...
            <div>
                <div className="h-60 w-full overflow-hidden">
                    <Link to={"/chi-tiet-bai-viet/"+props.id}>
                        <img alt="" srcSet={$linkImage+props.image+ " 2x"} className="h-60 w-full object-cover img-scale duration-150"/>
                    </Link>
                </div>
                <div className="p-4">
                    <div className="line-2 text-xl font-semibold mb-4">
                        <h5>
                            <Link to={"/chi-tiet-bai-viet/"+props.id} className="text-gray-800 hover:text-purple-800">
                                {props.name}
                            </Link>
                        </h5>
                    </div>
