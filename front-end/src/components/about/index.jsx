...
const arr = [
    {
        title: 'Giảng viên',
        image: `${process.env.REACT_APP_URL_SERVER}/upload/images/about_1.png`,
    ...
    {
        title: 'Môi trường',
        image: `${process.env.REACT_APP_URL_SERVER}/upload/images/about_2.png`,
    ...
    {
        title: 'Giáo trình',
        image: `${process.env.REACT_APP_URL_SERVER}/upload/images/about_3.png`,
