...
const About = (props) => {
    return (
        <div className="bg-no-repeat bg-cover w-full h-788 md:h-508 object-cover bg-center rounded-lg overflow-hidden relative mt-10" style={{ backgroundImage: `url("./assets/images/bg/about.jpg")` }}>
