...
const BannerItem = (props) => {
    return (
        <div className="relative lg:h-700 h-96 bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('http://localhost:8000/upload/images/banner/"+props.data.image+"')"}}>
            ...
            <div className="absolute lg:top-1/4 top-12 left-0 w-full h-2/5 mt-20">
                <div className="w-11/12 h-full mx-auto">
                    <div className="md:w-7/12 w-full text-center md:text-left h-full px-4 lg:px-0 text-white">
                        ...
                        <p className="text-base mb-10 mt-2 line-2">KẾT NỐI - CHIA SẺ - TRUYỀN ĐAM MÊ </p>
