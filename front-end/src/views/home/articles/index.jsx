                    ...
                    <div>
                        <form action="#" className="relative">
                            <input
                                ...
                                className="block px-6 py-3 w-full focus:border-indigo-500 border-gray-300 hover:border-gray-400 rounded-sm outline-none border-2"
                                required
                            />
                            <button
                                type="submit"
                                className="leading-5 absolute top-0 right-0 text-indigo-500 p-2 h-full px-4 rounded-sm"
                            >
