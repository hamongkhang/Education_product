                      ...
                      return(
                        ...
                        {props.exam.map((item2) => {
                          if(item2.category_id===item.id){
                            var kt2=0;
                            for (var i=0; i < historyExam2.length; i++) {
                              if(historyExam2[i].product_id===item2.id){
                                       kt2=1;
                              }
                            }
                           return(
                              <li className="other-doc-left__list--li" onClick={() => props.handleExamDetails(item2.id, kt2)}>
                                <a href="#">{item2.name}</a>
                              </li>
                          );}
                        }
