...
const OrderTable = (props) => {
    ...
    const ExportUser = () => {
        setIsLoading(true);
        fetch(`${process.env.REACT_APP_URL_SERVER}/api/order/exportOrderLink`, {
            method: 'GET',
            headers: { Authorization: `Bearer ` + $token },
        })
            .then((response) => response.json())
    ...
    const deleteOrder = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                setIsLoading(true);
                fetch(
                    `${process.env.REACT_APP_URL_SERVER}/api/order/destroyOrder`,
                    {
                        method: 'POST',
                        body: _formData,
                        headers: { Authorization: `Bearer ` + $token },
                    ...
                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
                        <div className="rounded-t mb-0 px-4 py-3 border-0">
                            <div className="flex flex-wrap items-center">
                                ...
                                <div className="relative w-full flex items-center max-w-full flex-grow flex-1">
                                    <div className="uppercase text-gray-600 text-xs font-bold inline mr-2">
                                        Từ
                                    </div>
                                    <input
                                        type="date"
                                        ...
                                        className="text-13 px-3 py-1 outline-none border border-purple-800 focus:border-purple-900 rounded"
                                    />
                                    <div className="uppercase text-gray-600 text-xs font-bold inline mx-2">
                                        Đến
                                    </div>
                                    <input
                                        type="date"
                                    ...
                                    >
                                        <div className="py-2 bg-white shadow-lg text-13">
                                            ...
                                            <input
                                                ...
                                                className={`border-0 mx-2 px-3 py-2 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring  ease-linear transition-all duration-150 ${classOptionFile}`}
                                                type="file"
