...
const EditContent = () => {
        ...
        fetch(`${process.env.REACT_APP_URL_SERVER}/api/getTableOfContents`, {
            ...
            .then((data) => {
                ...
                if (data.table_of_contents) {
                    ...
                    setContent({
                        ...content,
                        ['table_of_content_id']: data.table_of_contents[0].id,
                    });
                }
                setIsLoading(false);
            });
    ...
    const getOneContent = () => {
        ...
        setIsLoading(true);
        fetch(`${process.env.REACT_APP_URL_SERVER}/api/getOneContent`, {
            method: 'POST',
            body: _formData,
            headers: { Authorization: `Bearer ` + $token },
        })
    ...
    const updateContent = () => {
        ...
        setIsLoading(true);
        fetch(`${process.env.REACT_APP_URL_SERVER}/api/updateContent`, {
            method: 'POST',
            body: _formData,
            headers: { Authorization: `Bearer ` + $token },
        })
