...
const Content = (props) => {
    ...
    const getContents = () => {
        ...
        fetch(`${process.env.REACT_APP_URL_SERVER}/api/getContents`, {
            ...
            .then((data) => {
                ...
                if (data.contents) {
                    if (param.id_table) {
                        let table = data.contents.filter(
                            (item) =>
                                item.table_of_content_id == param.id_table,
                        );
    ...
    const onChangeView = (e) => {
        if (Number(e.target.value)) {
            ...
            let contents1 = contents.filter(
                (item) => item.table_of_content_id == param.id_table,
            );
