                ...
                <div className="w-full">
                    ...
                    <div className="rounded-t mb-0 px-4 py-3 border-0">
                        ...
                        <div className="relative w-full max-w-full flex-grow flex-1">
                               ...
                               <select name="commentFilter" id="type" className="text-13 px-3 py-1 outline-none border border-purple-800 focus:border-purple-900 rounded" 
                                onChange={(event) => onChangeView(event)}>
                                    <option value={null}>Xem tất cả</option>
                                    {lessons.map((item,index)=> <option key={index} value={item.id}>{item.name}</option>)}
                                </select>
                           </div>
                        </div>
                    </div>
                                ...
                                commentFilter.map((item,index)=>{
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                            {userComment[item.index]}
                                        </td>
                                        <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                            {lessonComment[item.index]}
                                        </td>
                                        <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                            {item.message}
                                        </td>
                ...
                <div className="w-full">
                    ...
                    <div className="rounded-t mb-0 px-4 py-3 border-0">
                        ...
                        <div className="relative w-full max-w-full flex-grow flex-1">
                               ...
                               <select name="commentReplyFilter" id="type" className="text-13 px-3 py-1 outline-none border border-purple-800 focus:border-purple-900 rounded" 
                                onChange={(event) => onChangeView(event)}>
                                    <option value={null}>Xem tất cả</option>
                                    {lessons.map((item,index)=> <option key={index} value={item.id}>{item.name}</option>)}
                                </select>
                    ...
                    <div className="block w-full overflow-x-auto">
...

                        {
                             ...
                             commentReplyFilter.map((items,index)=>{
                                return(
                                <tr key={index}>
                                    <th className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left text-blueGray-700 ">
                                        {index+1}
                                    ...
                                    <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                        {userCommentReply[items.index]}
                                    </td>
                                    <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                    {lessonCommentReply[items.index]}
                                    </td>
                                    <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                        {items.message}
                                    </td>
