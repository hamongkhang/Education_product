                ...
                <div className="w-full">
                    ...
                    <div className="rounded-t mb-0 px-4 py-3 border-0">
                        ...
                        <div className="relative w-full max-w-full flex-grow flex-1">
                            <input type="text" name="examCategoryAdminSearch" onChange={(event) => searchHandle(event)} placeholder="Tìm kiếm..." className="text-13 px-3 py-1 outline-none border border-purple-800 focus:border-purple-900 rounded"/>
                        </div>
                    ...
                    <div className="block w-full overflow-x-auto">
                        ...
                        <tbody>

                            {
                                ...
                                examCategoryAdminSearch.map((item,index)=>{
                                    return(
                                    <tr key={index}>
             ...
             <h6 className="text-gray-700 text-xl font-bold mb-4">Bài kiểm tra</h6>
                <div className="w-full">
                    ...
                    <div className="rounded-t mb-0 px-4 py-3 border-0">
                        <div className="flex flex-wrap items-center">
                        <div className="relative w-full max-w-full flex-grow flex-1">
                            <input type="text" placeholder="Tìm kiếm..." name="examAdminSearch" onChange={(event) => searchHandle(event)} className="text-13 px-3 py-1 outline-none border border-purple-800 focus:border-purple-900 rounded"/>
                        </div>
                        <div className="relative w-full max-w-full flex-grow flex-1 text-right">
