...
const IndexQuestionExam = () => {
    ...
    const handleOptionInput = () => {
        classOptionInput === 'hidden'
            ? setClassOptionInput('block')
            : setClassOptionInput('hidden');
    };
                            ...
                            <table className="items-center bg-transparent w-full border-collapse ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                            {examCategoryQuestionEdit.map(
                                                (bt, i) => {
                                                    if (
                                                        examQuestionEdit.category_id ==
                                                        bt.id
                                                    ) {
                                                        return bt.name;
                                                    }
                                    ...
                                    >
                                        <div className="py-2 bg-white shadow-lg text-13">
                                            ...
                                            <input
                                                ...
                                                type="number"
                                                className={`border-0 mx-2 px-3 py-2 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring  ease-linear transition-all duration-150 ${classOptionInput}`}
                                            ></input>
                                            <Link
                                                className={`block w-full py-1 text-left px-2 hover:bg-gray-200  ${classOptionInput}`}
                                                to={`/admin/exam/${match.params.id}/addQuestionAnswer/${number.num}`}
                                            >
                                                Submit
                                            </Link>
                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                    <div className="space-x-2">
                                                        <Link
                                                            to={`/admin/exam/${match.params.id}/editQuestion/${items.id}`}
