...
const AddDocumentCategory = () => {
    ...
    const onAddDocumentCategory = () => {
        ...
        fetch("http://localhost:8000/api/freeDocumentCategory/createFreeDocumentCategory", {
            method: "POST",
            body:_formData,
    ...
    const onChangeHandle = (event) => {
        ...
        if(_type === "checkbox"){
            if(event.target.checked){
                setDocumentCategoryAdd({...documentCategoryAdd,["status"]:"Active"})
                ...
                setDocumentCategoryAdd({...documentCategoryAdd,["status"]:"Block"})
        ...
        <section className=" py-1">
            <div className="w-full">
                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                            ...
                            <div className="relative w-full mb-3">
                                ...
                                <label htmlFor={`toggle`} className="toggle-label">
                                    <input type="checkbox" name="status" id={`toggle`} 
                                        defaultChecked = {documentCategoryAdd.status === 'Active'?true:false}
                    ...
                    <button type="button" onClick={()=>onAddDocumentCategory()} className="bg-indigo-600 text-white px-5 py-2 rounded hover:bg-indigo-700 hover:shadow-xl font-semibold duration-300">Thêm</button>
                    </form>
                </div>
                </div>
            </div>
