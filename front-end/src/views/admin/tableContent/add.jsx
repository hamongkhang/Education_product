            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                        ...
                        <button type="button" onClick={()=>addTableOfContent()} className="bg-indigo-600 text-white px-5 py-2 rounded hover:bg-indigo-700 hover:shadow-xl font-semibold duration-300">Thêm</button>
                    </div>
                </div>
                </form>
            </div>
