...
const TableContent = (props) => {
    ...
    const getTableOfContents = () =>{
        ...
        .then(data =>  {
            console.log(data.table_of_contents);
            if(data.url){
                let url = data.url;
                history.push(url);
            }
            if(data.table_of_contents){
                if(param.id){
                    ...
                    let table = data.table_of_contents.filter(item => item.course_id == param.id)
    ...
    return (
        ...
        <section className="bg-blueGray-50">
            <h6 className="text-gray-700 text-xl font-bold mb-4">Danh mục nội dung</h6>
                                   ...
                                   <tr key={index}>
                                       ...
                                       <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                           <div className="space-x-2">
                                               <Link to={`/admin/content/${item.id}`} className="py-1 px-2 text-white rounded hover:opacity-80 bg-blue-400 shadow-lg block md:inline-block">View</Link>
