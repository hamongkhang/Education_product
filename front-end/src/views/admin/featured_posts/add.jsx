                            ...
                            <div className="relative w-full mb-3">
                                ...
                                <label htmlFor={`toggle`} className="toggle-label">
                                    <input type="checkbox" name="status" id={`toggle`} 
                                        defaultChecked = {postAdd.status === 'Active'?true:false}
                        ...
                        <div className="w-full lg:w-12/12 px-4 mt-10">
                            <div className="relative w-full mb-3">
                                ...
                                <JoditEditor
                                    config={config}
                                    tabIndex={1}
                                    onBlur={newContent => setPostAdd({...postAdd,["description"]:newContent})} 
                                />
                                <span className="text-red-500 text-sm">{error.description?error.description[0]:""}</span>
                            </div>
                        </div>
                    </div>
                    <button type="button" onClick={()=>addExamPost()} className="bg-indigo-600 text-white px-5 py-2 rounded hover:bg-indigo-700 hover:shadow-xl font-semibold duration-300">Thêm</button>
                    </form>
                </div>
                </div>
            </div>
