                    ...
                    <div className="flex flex-wrap">
                        <div className="w-full lg:w-6/12 px-4">
                            <div className="relative w-full mb-3">
                                ...
                                <input type="text" name="name" className="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" onChange={(event) => onChangeHandle(event)} value={course.name}/>
                        ...
                        <div className="w-full lg:w-3/12 px-4">
                            <div className="relative w-full mb-3">
                                ...
                                <input type="number" name="promotion" min="0" className="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" onChange={(event) => onChangeHandle(event)} value={course.promotion} onBlur ={(event) => onBlurHandle(event)} />
                        ...
                        <div className="w-full lg:w-6/12 px-4">
                            <div className="relative w-full mb-3">
                                ...
                                <input type="number" disabled name="promotion_price" min="0" className="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" value={course.promotion_price}  />
                            </div>
                        </div>
                        <div className="w-full lg:w-6/12 px-4">
                            <div className="relative w-full mb-3">
                                ...
                                <select name="category_course" id="type" className="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" onChange={(event) => onChangeHandle(event)}>
                                   {
                                       categoryCourses.map((item,index)=>(
                                            <option key={index} value={item.id} selected = {item.id === course.category_course?true:false}>{item.name}</option>
                                       ))
                                   }
                        ...
                        <div className="w-full px-4">
                            <div className="relative w-full mb-3 group h-96">
                                ...
                                <img src={file ? URL.createObjectURL(file):$link+course.image}  className="w-full min-h-96 h-full mb-30 md:mb-1 object-scale-down rounded-lg" alt=""/>
                        ...
                        <div className="w-full lg:w-12/12 px-4">
                            <div className="relative w-full mb-3">
                                ...
                                <DraftjsWidget value={course.target} onChange={(editorState)=>onChangeEditor(editorState,"target")}/>
                        ...
                        <div className="w-full lg:w-12/12 px-4">
                            <div className="relative w-full mb-3">
                                ...
                                <DraftjsWidget value={course.benefit} onChange={(editorState)=>onChangeEditor(editorState,"benefit")}/>
                        ...
                        <div className="w-full lg:w-12/12 px-4">
                            <div className="relative w-full mb-3">
                                ...
                                <DraftjsWidget value={course.description} onChange={(editorState)=>onChangeEditor(editorState,"description")}/>
                                <span className="text-red-500 text-sm">{error.description?error.description[0]:""}</span>
                            </div>
                        </div>
                    </div>
                        <button type="button" onClick={()=>updateCourse()} className="bg-indigo-600 text-white px-5 py-2 rounded hover:bg-indigo-700 hover:shadow-xl font-semibold duration-300">Cập nhật</button>
                    </form>
                </div>
                </div>
            </div>
