    ...
    const getCourses = () => {
        ...
        fetch(`${process.env.REACT_APP_URL_SERVER}/api/getCourses`, {
            ...
            .then((data) => {
                ...
                if (data.data) {
                    if (param.id_cate) {
                        let courses1 = data.data.filter(
                            (item) => item.category_course == param.id_cate,
                        );
                                              ...
                                              return (
                                                  <tr key={index}>
                                                      ...
                                                      <td className="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                                          <Link
                                                              to={`/admin/table_content/${item.id}`}
                                                          >
                                                              {item.name}
                                                          </Link>
                                                      </td>
