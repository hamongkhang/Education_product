...
const EditCategoryCourse = () => {
    ...
    const getOneCategoryCourse = () =>{
        const _formData = new FormData();
        _formData.append("id",match.params.id)
        fetch("http://localhost:8000/api/getOneCategoryCourse", {
            method: "POST",
            body:_formData,
            headers: {"Authorization": `Bearer `+$token}
          })
        ...
        .then(data =>  {
            if(data.error){
                ...
                setCategory(data.category_course)
                console.log(data);
            }
            ...
            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full lg:w-6/12 px-4">
                        ...
                        <button type="button" onClick={()=>updateCategory()} className="bg-indigo-600 text-white px-5 py-2 rounded hover:bg-indigo-700 hover:shadow-xl font-semibold duration-300">Cập nhật</button>
                    </div>
                </div>
                </form>
            </div>
...
export default EditCategoryCourse